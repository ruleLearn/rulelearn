...
/**
 * Coverage outside approximation measure, calculated to check the number of objects not belonging to an approximation which are covered by rule conditions
 *
...
public class CoverageOutsideApproximationMeasure implements CostTypeMeasure, RuleConditionsEvaluator, MonotonicConditionAdditionEvaluator, ConditionRemovalEvaluator {
	...
	public double evaluate(RuleConditions ruleConditions) {
		...
		return getNumberOfElementsFromListNotPresentInSet(coveredObjects, approximationObjects);
	}
