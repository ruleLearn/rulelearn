...
/**
 * Contract for a classifier capable of producing for each object from an information table a single {@link SimpleClassificationResult}.
 *
...
public interface SimpleClassifier extends Classifier {
	...
	/**
	 * Classifies single object from the given information table.
	 * 
	 ...
	 * @return array with simple classification results for subsequent objects from the given information table
	 * @throws NullPointerException if given information table is {@code null}
	 */
	@Override
