...
public abstract class RealField extends SimpleField {
	 ...
	 * 
	 * @throws ClassCastException if the other simple field has a value (i.e., its value is not missing according to {@link SimpleField#hasValue()}) and is not of type {@link RealField}
	 ...
	 * {@inheritDoc}
	 * 
	 * @return {@code true}, as value of this real field is always known.
	 */
	@Override
